...
IUSE="doc elogind +i18n libinput systemd v4l vanilla-datetime vanilla-hostname wayland"
REQUIRED_USE="
	?? ( elogind systemd )
...
src_configure() {
	local emesonargs=(
		-D option=disable-update-mimedb
		-D option=disable-static
		-D cheese=$(usex v4l true false)
		-D documentation=$(usex doc true false)
		-D ibus=$(usex i18n true false)
		-D tracing=false
